...
# noinspection PyArgumentList,PyUnresolvedReferences,PyMissingOrEmptyDocstring
class AppConfigTest(CombinedTestCase) :
  ...
  def test_app_config(self) -> None :
    ...
    with self.assertRaises(TypeError):
      ServiceConfig()  # type: ignore[abstract,call-arg]  # pylint: disable=abstract-class-instantiated,no-value-for-parameter
