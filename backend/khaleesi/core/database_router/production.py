...
class DatabaseRouter:
  ...
  def db_for_read(self, _model: Type[Model], **_: Any) -> str :  # pylint: disable=invalid-name
    """Return the database alias for reads."""
    return 'read'

  def db_for_write(self, _model: Type[Model], **_: Any) -> str :  # pylint: disable=invalid-name
